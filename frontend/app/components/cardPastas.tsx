...
const CardPastas: React.FC<CardPastasProps> = ({
  ...
  return (
        <div
        className="relative w-full max-w-[440px] h-[200px] bg-white rounded-[30px] shadow-md flex flex-col justify-center cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] p-6"
        style={{
